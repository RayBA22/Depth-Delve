...
```
cd existing_repo
git remote add origin https://forge.univ-lyon1.fr/p2210996/depths-delve-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://forge.univ-lyon1.fr/p2210996/depths-delve-project/-/settings/integrations)
