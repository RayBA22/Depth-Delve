...
![Exploration d’un étage avec ennemis](assets/captureS/menu.png)
![Inventaire avec les ressources collectées](assets/captureS/menu.png)
![Combat contre une créature souterraine](assets/captures/menu.png)
