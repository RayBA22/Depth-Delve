...
![Exploration d’un étage avec ennemis](assets/capture/menu.png)
![Inventaire avec les ressources collectées](assets/capture/menu.png)
![Combat contre une créature souterraine](assets/capture/menu.png)
